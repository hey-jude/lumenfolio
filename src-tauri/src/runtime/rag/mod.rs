...
#[allow(dead_code)]
pub fn merge_retrieval_citations(accumulated: &mut Vec<Citation>, citations: &[Citation]) {
...
impl RagToolName {
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AnalyzeVisual => "analyze_visual",
...
#[allow(dead_code)]
pub fn rag_tool_specs() -> Vec<RagToolSpec> {
    rag_tool_specs_for_capabilities(false)
}
